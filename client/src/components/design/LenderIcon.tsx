...
export function LenderIcon({ lender, size = 40 }: LenderIconProps) {
  ...
  switch (variant) {
    case "bank-blue":
      return <BankBlue size={size} />;
    case "bank-green":
      return <BankGreen size={size} />;
    case "bank-orange":
      return <BankOrange size={size} />;
    case "credit-card":
