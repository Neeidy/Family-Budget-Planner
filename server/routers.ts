...
const jsonArrayString = z.string()
  ...
  familyBudget: router({
    ...
    save: familyProtectedProcedure
      .input(z.object({
        ...
        savings: jsonArrayString.optional().default('[]'),
      ...
      .mutation(async ({ input, ctx }) => {
        const result = await saveFamilyBudget(FAMILY_ID, {
        ...
        }, input.expectedUpdatedAt, ctx.family?.person ?? null);
      ...
      restore: familyProtectedProcedure
        ...
        .mutation(async ({ input, ctx }) => {
          ...
          try {
            ...
            throw new TRPCError({ code: 'INTERNAL_SERVER_ERROR', message: 'Snapshot verisi bozuk, geri yüklenemedi' });
          }
